...
class Material(object):
    ...
    def get_wavelengths(sim):
        if sim.fdtd.getglobalmonitor('sample spacing') == 'uniform':
            ...
            return Wavelengths(start = (sp.constants.speed_of_light/(sim.fdtd.getglobalmonitor('custom frequency samples'))).flatten())
